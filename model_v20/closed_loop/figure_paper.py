...
lambda_1 = (
    k_3 * k_f * (
        k_2**3 * (k_2 + k_3 * k_f) * k_in * (k_3 * k_f - k_2 * k_in)
        + k_1 * k_3**2 * k_f * (k_3 * (k_2 + k_3 * k_f)**2 + k_2**3 * k_in)
        + b * k_2**2 * (k_2 + k_3 * k_f) * (
            k_3 * k_f * (k_2 + k_3 * (k_1 + k_f))
            - k_2 * (k_2 + k_3 * k_f) * k_in
        )
    )
)
...
lambda_2 = (
    (k_2 + k_3 * k_f) * (
        ...
        + k_2 * (k_2 + k_3 * k_f) * (
            k_2**2 * (2 * b * k_2 + k_3 + k_1 * k_3**2)
            + 3 * k_2 * k_3 * (b * k_2 + k_3) * k_f
            + 2 * k_3**3 * k_f**2
        ) * k_in
        + k_2**4 * (k_2 + 2 * k_3 * k_f) * k_in**2
    )
)
