...
line1, = ax1.plot(t_grid_o, X_f_part, linestyle="solid", color="green", label = "LNA", alpha = 0.7)

line2, = ax1.plot(t_grid_l, x_output_mean, linestyle="dashed", color="black", label = "Linearized LNA", alpha = 0.6)
...
max_y_value = max(max(X_f_part), max(x_output_mean))
min_y_value = min(min(X_f_part), min(x_output_mean))
...
line1, = ax1.plot(t_grid_o, X_fano_part, linestyle="solid", color="green", label = "LNA", alpha = 0.7)

line2, = ax1.plot(t_grid_l, x_fano, linestyle="dashed", color="black", label = "Linearized LNA", alpha = 0.6)
...
max_y_value = max(max(X_fano_part), max(x_fano))
min_y_value = min(min(X_fano_part), min(x_fano))
y_lower = min_y_value - abs(min_y_value) * 0.16
y_upper = max_y_value + abs(max_y_value) * 0.16
plt.ylim(y_lower, y_upper)
...
line1, = ax1.plot(t_grid_o, V_X_part, linestyle="solid", color="green", label = "LNA", alpha = 0.7)

line2, = ax1.plot(t_grid_l, x_output_var, linestyle="dashed", color="black", label = "Linearized LNA", alpha = 0.6)
...
max_y_value = max(max(V_X_part), max(x_output_var))
min_y_value = min(min(V_X_part), min(x_output_var))
y_lower = min_y_value - abs(min_y_value) * 0.16
y_upper = max_y_value + abs(max_y_value) * 0.16
plt.ylim(y_lower, y_upper)
