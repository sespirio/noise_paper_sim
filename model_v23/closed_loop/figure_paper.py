...
lambda_1 = (
    b**2 * (-1 + c) * c * k_2**4 * p_1 * p_2
    + b * k_2 * k_3 * (
        k_3 * (
            2 * k_3 * k_f**2 * (k_1 + k_in)
            + c * k_2 * ((-1 + c) * k_1 * k_2 + 2 * k_f * k_in) * p_1
        )
        + 2 * k_2 * k_3 * k_f**2 * p_2
        + (-1 + c) * c * k_2**2 * p_1 * p_2**2
    )
    + k_3**3 * k_f * (
        c * k_2 * k_in * p_1 * (2 * k_f + p_2 * (1 - c))
        + 2 * k_3 * k_f * (k_f * k_in + k_1 * p_2)
    )
)
...
lambda_2 = (
    2 * (k_3 * k_f + c * k_2 * p_1) * (
        b**2 * k_2**3 * p_2
        - k_3**3 * k_f * k_in * p_2
        + b * k_2 * k_3 * (k_3 * (k_1 * k_2 - k_f * k_in) + k_2 * p_2**2)
    )
)
